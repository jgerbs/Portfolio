/* ============================================================
   ransomwareDemo/breakdown/script.js
   Evidence carousel for the ransomware incident report page.

   Responsibilities:
   - Defines the ordered list of evidence images and captions
   - Wires up previous/next navigation buttons to cycle through evidence
   - Updates the displayed image and caption on each navigation event
   - Initializes the viewer to the first evidence item on DOMContentLoaded

   Sections:
   1) EVIDENCE IMAGE + CAPTION DATA
